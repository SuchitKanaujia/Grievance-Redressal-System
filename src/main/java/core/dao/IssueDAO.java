...
public class IssueDAO {
	...
	public static ArrayList<Issue> fetchIssues(String whereClause){
		...
		try {
			...
			ArrayList<String> selectedColumns = new ArrayList<>(Arrays.asList
					("Id", "Registered_By", "Domain_Id", "Description", "Curr_Status", "Assigned_To"));
	...
	public static void main(String args[]) {
		Issue i = new Issue();
		i.setRegistered_By("20BME254");
		i.setDomain_Id("ELECTRICITY");
		i.setDescription("Light nahss2i2 aa rhi");
		System.out.println("Issue Id: " + insertIssue(i));
	}
