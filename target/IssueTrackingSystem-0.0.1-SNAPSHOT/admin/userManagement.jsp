<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	import="its.userlevel.*, java.sql.*, java.util.*"
...
<body>
	...
	<div class="row">
		<div class="col-sm-2" style="height: 680px;">
			<div class="sidebar" style="width: auto;">
				...
				<a href="#" onclick="multiUserCreation()">User
					Creation(Multiple)</a> <a href="#" onclick="userModification()">User
					Modification</a> <a href="#" onclick="userDeletion()">User Deletion</a>
			</div>
		</div>
		...
		<div id="main" class="col-sm-10">
			...
			<div class="userManagementHomePage" id="user-management-homepage">
				<h1 style="color: #346e5f; text-align: center; margin-top: 20px;">User
			...
			<div class="addSingleUserForm" id="add-single-user-form">
				...
				<form name="addUser" action="" id="form-addUser">
					...
					<fieldset id="field-personal-info" hidden>
						...
						<div class="infoLabel" id="label-personal-info"
							style="margin-top: 0;">
						...
						<div class="form-group row" id="div-email">
							...
							<div class="col-sm-2 form-label-container">
								<label class="form-label" for="alternateEmail">Alternate
									Email:</label>
							</div>
							<div class="col-sm-4 form-input-container">
								<input type="email" class="form-control form-input"
									id="alternateEmail" name="alternateEmail">
							</div>
						</div>
						...
						<div class="form-group row" id="div-contact">
							...
							<div class="col-sm-4 form-input-container">
								<input type="phone" class="form-control form-input"
						...
						<div id="field-address">
							<div id="div-permanent-addr">
								<div class="infoLabel">
									<h4>Permanent Address</h4>
								</div>
								<div class="form-group row" id="div-p-address-lines1">
									<div class="col-sm-2 form-label-container">
										<label class="form-label" for="p-address1">Address Line
											1:</label>
									</div>
									<div class="col-sm-4 form-input-container">
										<input type="text" class="form-control form-input"
											id="p-address1" name="p-address1"
											placeholder="Door No/Flat No/House No">
									</div>
									<div class="col-sm-2 form-label-container">
										<label class="form-label" for="p-address2">Address Line
											2:</label>
									</div>
									<div class="col-sm-4 form-input-container">
										<input type="text" class="form-control form-input"
											id="p-address2" name="p-address2"
											placeholder="Lane/Locality/Village/Town">
									</div>
								</div>
								...
								<div class="form-group row" id="div-p-country-state">
									<div class="col-sm-2 form-label-container">
										<label class="form-label" for="p-country">Select
											Country:</label>
									</div>
									<div class="col-sm-4 form-input-container">
							...
							<div class="form-group row" id="div-same-current-permanent-addr">
								<div class="checkbox col-sm-8 form-input-container">
									<label><input type="checkbox"
										onclick="addressChange();" id="same-address"> Current Address Same as
										Permanent Address</label>
								</div>
								<div class="col-sm-4"></div>
							</div>

							<div id="div-current-addr">
								<div class="infoLabel">
								...
								<div class="form-group row" id="div-c-address-lines1">
									<div class="col-sm-2 form-label-container">
										<label class="form-label" for="c-address1">Address Line
											1:</label>
									</div>
									<div class="col-sm-4 form-input-container">
										<input type="text" class="form-control form-input"
											id="c-address1" name="c-address1"
											placeholder="Door No/Flat No/House No">
									</div>
									<div class="col-sm-2 form-label-container">
										<label class="form-label" for="c-address2">Address Line
											2:</label>
									</div>
									<div class="col-sm-4 form-input-container">
										<input type="text" class="form-control form-input"
											id="c-address2" name="c-address2"
											placeholder="Lane/Locality/Village/Town">
									</div>
								</div>
								...
								<div class="form-group row" id="div-c-country-state">
									<div class="col-sm-2 form-label-container">
										<label class="form-label" for="c-country">Select
											Country:</label>
									</div>
									<div class="col-sm-4 form-input-container">
					...
					<fieldset id="field-parent-info" hidden>
						...
						<div id="div-father-info">
							<div class="infoLabel" style="margin-top: 0;">
							...
							<div class="form-group row" id="div-fdetails2">
								<div class="col-sm-2 form-label-container">
									<label class="form-label" for="fatherContact">Contact
										No:</label>
								</div>
								<div class="col-sm-2 form-input-container">
									<input type="text" class="form-control form-input"
										id="fatherContact" name="fatherContact">
								</div>
								<div class="col-sm-2 form-label-container">
								...
								<div class="col-sm-2 form-input-container">
									<input type="text" class="form-control form-input"
										id="fatherOcc" name="fatherOcc">
								</div>
								<div class="col-sm-2 form-label-container">
									<label class="form-label" for="fatherIncome">Annual
										Income:</label>
								</div>
								<div class="col-sm-2 form-input-container">
									<input type="number" class="form-control form-input"
										id="fatherIncome" name="fatherIncome">
								</div>
							</div>
						</div>

						<div id="div-mother-info">
							<div class="infoLabel">
							...
							<div class="form-group row" id="div-mdetails1">
								...
								<div class="col-sm-4 form-input-container">
									<input type="email" class="form-control form-input"
										id="motherEmail" name="motherEmail">
								</div>
							</div>
							...
							<div class="form-group row" id="div-fdetails2">
								<div class="col-sm-2 form-label-container">
									<label class="form-label" for="motherContact">Contact
										No:</label>
								</div>
								<div class="col-sm-2 form-input-container">
									<input type="text" class="form-control form-input"
										id="motherContact" name="motherContact">
								</div>
								<div class="col-sm-2 form-label-container">
								...
								<div class="col-sm-2 form-input-container">
									<input type="text" class="form-control form-input"
										id="motherOcc" name="motherOcc">
								</div>
								<div class="col-sm-2 form-label-container">
									<label class="form-label" for="motherIncome">Annual
										Income:</label>
								</div>
								<div class="col-sm-2 form-input-container">
									<input type="number" class="form-control form-input"
										id="motherIncome" name="motherIncome">
								</div>
							</div>
						</div>
						<br>
					...
					<fieldset id="field-academic-info" hidden>
						...
						<div class="form-group row" id="div-procter-info">
							<div class="col-sm-2 form-label-container">
								<label class="form-label" for="procterId">Procter ID:</label>
							</div>
							<div class="col-sm-2 form-input-container">
								<input type="text" class="form-control form-input"
									id="procterId" name="procterId">
							</div>
							<div class="col-sm-2 form-label-container">
								<label class="form-label" for="procterName">Procter
									Name:</label>
							</div>
							<div class="col-sm-2 form-input-container">
								<input type="text" class="form-control form-input"
									id="procterName" name="procterName">
							</div>
							<div class="col-sm-2 form-label-container">
						...
						<div class="form-group row" id="div-emp-basic-info">
							<div class="col-sm-2 form-label-container">
								<label class="form-label" for="empId">Employee ID:</label>
							</div>
							<div class="col-sm-4 form-input-container">
								<input type="text" class="form-control form-input" id="empId"
									name="empId">
							</div>
							<div class="col-sm-2 form-label-container">
						...
						<div class="form-group row" id="div-depdesdoj">
							<div class="col-sm-2 form-label-container">
						...
						<div class="form-group row" id="div-domdoj">
							<div class="col-sm-2 form-label-container">
						...
						<div class="form-group row" id="div-domdesdoj">
							<div class="col-sm-2 form-label-container">
								<label class="form-label" for="domain">Domain:</label>
							</div>
							<div class="col-sm-2 form-input-container">
					...
					<fieldset id="field-hostel-info" hidden>
						...
						<div class="form-group row" id="div-hostel2">
							...
							<div class="col-sm-2 form-label-container">
								<label class="form-label" for="foodPreference">Food
									Preference:</label>
							</div>
							<div class="col-sm-2 form-input-container">
								<select class="form-control" id="foodPreference"
									name="foodPreference">
					...
					<div class="form-group row" style="margin-top: 15px;"
						...
						<div class="col-sm-4">
							<button type="button"
								...
								onclick="alert('User Created');">Create User</button>
						</div>
						<div class="col-sm-4">
			...
			<div class="addMultiuserForm" id="add-multi-user-form">
				...
				<div class="row">
					<div class="col-md-12">
						<a href="../files/Data_csv_file.csv" download="sample.csv">Click</a>
						here to download a sample csv file
					</div>
				</div>
				<form class="form-horizontal">
					<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<button type="button"
									class="btn btn-outline-success btn-md  form-control">Create
									Users</button>
							</div>
							<div class="col-md-4">
								<button type="button"
						...
						<div class="row">
							...
							<div class="col-md-6">
								<button type="button"
									class="btn btn-outline-success btn-md  form-control" disabled>Download
									User Creation Report</button>
							</div>
							<div class="col-md-3"></div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<select class="custom-select custom-select-md mb-3"
									onchange="modifySectionEnableFields()"
									id="modify-userlevel-select">
	...
	function unhideHiddenFields() {
		document.getElementById("div-name").hidden = false;
		document.getElementById("div-other-info").hidden = false;
		document.getElementById("div-email").hidden = false;
		document.getElementById("div-contact").hidden = false;
		document.getElementById("div-permanent-addr").hidden = false;
		document.getElementById("div-current-addr").hidden = false;
		document.getElementById("div-same-current-permanent-addr").hidden = false;
		document.getElementById("div-father-info").hidden = false;
		document.getElementById("div-mother-info").hidden = false;
		document.getElementById("div-stu-basic-info").hidden = false;
		document.getElementById("div-procter-info").hidden = false;
		document.getElementById("div-emp-basic-info").hidden = false;
		document.getElementById("div-depdesdoj").hidden = false;
		document.getElementById("div-domdoj").hidden = false;
		document.getElementById("div-domdesdoj").hidden = false;
	}
	...
	//User Level Selection Action Function
	   		...
	   		try{
		   		...
		   		request.onreadystatechange  = function(){  
		      		if (request.readyState == 4  ){
		    	  		...
		    	  		unhideHiddenFields();
		    	  		if(ulObj.a_name==="NO"){
		    	  			document.getElementById("div-name").hidden = true;
		    	  		}if(ulObj.a_dgbg==="NO"){
		    	  			document.getElementById("div-other-info").hidden = true;
		    	  		}if(ulObj.a_email==="NO"){
		    	  			document.getElementById("div-email").hidden = true;
		    	  		}if(ulObj.a_contact==="NO"){
		    	  			document.getElementById("div-contact").hidden = true;
		    	  		}if(ulObj.a_paddr==="NO"){
		    	  			document.getElementById("div-permanent-addr").hidden = true;
		    	  		}if(ulObj.a_caddr==="NO"){
		    	  			document.getElementById("div-current-addr").hidden = true;
		    	  		}if(ulObj.a_paddr==="NO" || ulObj.a_caddr==="NO"){
		    	  			document.getElementById("div-same-current-permanent-addr").hidden = true;
		    	  		}if(ulObj.a_fdetails==="NO"){
		    	  			document.getElementById("div-father-info").hidden = true;
		    	  		}if(ulObj.a_mdetails==="NO"){
		    	  			document.getElementById("div-mother-info").hidden = true;
		    	  		}if(ulObj.a_fdetails==="NO" && ulObj.a_mdetails==="NO"){
		    	  			document.getElementById("field-parent-info").hidden = true;
		    	  		}if(ulObj.a_st_basic==="NO"){
		    	  			document.getElementById("div-stu-basic-info").hidden = true;
		    	  		}if(ulObj.a_procter==="NO"){
		    	  			document.getElementById("div-procter-info").hidden = true;
		    	  		}if(ulObj.a_emp_basic==="NO"){
		    	  			document.getElementById("div-emp-basic-info").hidden = true;
		    	  		}if(ulObj.a_depdesdoj==="NO"){
		    	  			document.getElementById("div-depdesdoj").hidden = true;
		    	  		}if(ulObj.a_domdoj==="NO"){
		    	  			document.getElementById("div-domdoj").hidden = true;
		    	  		}if(ulObj.a_domdesdoj==="NO"){
		    	  			document.getElementById("div-domdesdoj").hidden = true;
		    	  		}if(ulObj.a_hostel==="NO"){
		    	  			document.getElementById("field-hostel-info").hidden = true;
		    	  		}if(ulObj.a_pwd==="NO"){
		    	  			document.getElementById("field-login-info").hidden = true;
		    	  		}
